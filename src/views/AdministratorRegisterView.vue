<template>
    <div>
        ...
        <p class="text-center">Registro de Administradores</p>
        </div>
        </nav>
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <input v-model="userFormData.LugarNacimiento" type="text" id="birthplace" placeholder="Lugar de nacimiento" class="form-control" />
                    <div v-if="!userFormData.LugarNacimiento.trim()" class="text-danger">Este campo es obligatorio.</div>
                </div>
                <div class="col-12 mb-3">
                    <label for="birthdate" class="form-label">Fecha de nacimiento</label>
                    <input v-model="userFormData.FechaNacimiento" type="date" id="birthdate" placeholder="DD/MM/YYYY" class="form-control" :max="getCurrentDate()" />
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <div v-if="!userFormData.CorreoElectronico.trim()" class="text-danger">Este campo es obligatorio.</div>
                </div>
                <div class="col-12 col-md-6 mb-3">
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <input v-model="userFormData.Username" required @input="validateInput('Username')" type="user" id="user" placeholder="Usuario" class="form-control" />
            ...
            <button type="button" @click="registerAdmin" class="btn btn-success mt-3" :disabled="!isFormValid">Guardar</button>
            </div>
        </div>
        </div>
    </div>
  ...
  <style scoped>
  /* Aquí puedes añadir estilos específicos que no sean cubiertos por Bootstrap */
  </style>
